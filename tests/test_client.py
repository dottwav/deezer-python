...
from _deezer.exceptions import (
    _deezerErrorResponse,
    _deezerNotFoundError,
    _deezerUnknownResource,
)
...
class TestClient:
    ...
    def test_request_404(self, client):
        with pytest.raises(_deezerNotFoundError):
            client.request("GET", "does-not-exists")

    def test_request_unknown_resource(self, client):
        with pytest.raises(_deezerUnknownResource):
    ...
    def test_no_album_raise(self, client):
        ...
        with pytest.raises(_deezerErrorResponse):
            client.get_album(-1)
    ...
    def test_get_overall_chart(self, client):
        ...
        assert isinstance(result, _deezer.Chart)
        assert result.id == 0

        assert isinstance(result.tracks[0], _deezer.Track)
        assert isinstance(result.albums[0], _deezer.Album)
        assert isinstance(result.artists[0], _deezer.Artist)
        assert isinstance(result.playlists[0], _deezer.Playlist)
    ...
    def test_get_overall_tracks_chart(self, client):
        ...
        assert isinstance(result[0], _deezer.Track)
    ...
    def test_get_overall_albums_chart(self, client):
        ...
        assert isinstance(result[0], _deezer.Album)
    ...
    def test_get_overall_artists_chart(self, client):
        ...
        assert isinstance(result[0], _deezer.Artist)
    ...
    def test_get_overall_playlists_chart(self, client):
        ...
        assert isinstance(result[0], _deezer.Playlist)
    ...
    def test_get_overall_podcasts_chart(self, client):
        ...
        assert isinstance(result[0], _deezer.Podcast)
    ...
    def test_list_editorials(self, client):
        ...
        assert isinstance(editorials, _deezer.PaginatedList)
        assert isinstance(editorials[0], _deezer.Editorial)
    ...
    def test_get_genre(self, client):
        ...
        assert isinstance(genre, _deezer.Genre)
    ...
    def test_list_genres(self, client):
        ...
        assert isinstance(genres[0], _deezer.Genre)
    ...
    def test_list_radios(self, client):
        ...
        assert isinstance(radios[0], _deezer.Radio)

    def test_get_radios_top(self, client):
        radios = client.get_radios_top()
        assert isinstance(radios, _deezer.PaginatedList)
        assert isinstance(radios[0], _deezer.Radio)
    ...
    def test_get_user(self, client):
        ...
        assert isinstance(user, _deezer.User)
    ...
    def test_get_user_flow(self, client_token):
        ...
        assert isinstance(flow, _deezer.PaginatedList)
        track = flow[0]
        assert isinstance(track, _deezer.Track)
    ...
    def test_get_user_albums(self, client_token, args):
        ...
        assert isinstance(user_albums, _deezer.PaginatedList)
        assert all(isinstance(a, _deezer.Album) for a in user_albums)
    ...
    def test_get_user_artists(self, client_token, args):
        ...
        assert isinstance(user_artists, _deezer.PaginatedList)
        assert all(isinstance(a, _deezer.Artist) for a in user_artists)
    ...
    def test_get_user_followers(self, client_token, args):
        ...
        assert isinstance(user_followers, _deezer.PaginatedList)
        assert all(isinstance(a, _deezer.User) for a in user_followers)
    ...
    def test_get_user_followings(self, client_token, args):
        ...
        assert isinstance(user_followings, _deezer.PaginatedList)
        assert all(isinstance(a, _deezer.User) for a in user_followings)
    ...
    def test_get_user_history(self, client_token):
        ...
        assert isinstance(user_history, _deezer.PaginatedList)
        assert all(isinstance(t, _deezer.Track) for t in user_history)
    ...
    def test_get_user_tracks(self, client_token, args):
        ...
        assert isinstance(user_tracks, _deezer.PaginatedList)
        assert all(isinstance(a, _deezer.Track) for a in user_tracks)
    ...
    def test_search_simple(self, client):
        ...
        assert isinstance(result, _deezer.PaginatedList)
        first = result[0]
        assert isinstance(first, _deezer.Track)
    ...
    def test_search_albums(self, client):
        ...
        assert isinstance(result, _deezer.PaginatedList)
        first = result[0]
        assert isinstance(first, _deezer.Album)
    ...
    def test_search_artists(self, client):
        ...
        assert isinstance(result, _deezer.PaginatedList)
        first = result[0]
        assert isinstance(first, _deezer.Artist)
    ...
    def test_search_playlists(self, client):
        ...
        assert isinstance(result, _deezer.PaginatedList)
        first = result[0]
        assert isinstance(first, _deezer.Playlist)
    ...
    def test_with_language_header(self, header_value, expected_name):
        ...
        client_fr = _deezer.Client(headers={"Accept-Language": header_value})
    ...
    @pytest.mark.parametrize(
        ("json", "expected_type"),
        [
            ({"name": "Unknown", "type": "unknown-type"}, _deezer.Resource),
            ({"title": "Album", "type": "album"}, _deezer.Album),
            ({"name": "Artist", "type": "artist"}, _deezer.Artist),
            ({"name": "Editorial", "type": "editorial"}, _deezer.Editorial),
            ({"title": "Episode", "type": "episode"}, _deezer.Episode),
            ({"name": "Genre", "type": "genre"}, _deezer.Genre),
            ({"title": "Playlist", "type": "playlist"}, _deezer.Playlist),
            ({"title": "Podcast", "type": "podcast"}, _deezer.Podcast),
            ({"title": "Radio", "type": "radio"}, _deezer.Radio),
            ({"title": "Track", "type": "track"}, _deezer.Track),
            ({"name": "User", "type": "user"}, _deezer.User),
        ],
        ids=[
            "unknown",
            "album",
